 ...
 */
class CoreCCInvalidDataExceptionTest {
    @Test
    void checkStandardExceptionUsage() {
        AbstractCoreCCException exception = new CoreCCInvalidDataException("Exception message");
        ...
        exception = new CoreCCInvalidDataException("Exception message", cause);
        assertEquals("Exception message", exception.getMessage());
