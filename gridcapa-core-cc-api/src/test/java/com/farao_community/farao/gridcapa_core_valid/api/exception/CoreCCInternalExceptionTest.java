 ...
 */
class CoreCCInternalExceptionTest {

    @Test
    void checkStandardExceptionUsage() {
        AbstractCoreCCException exception = new CoreCCInternalException("Exception message");
        ...
        exception = new CoreCCInternalException("Exception message", cause);
        assertEquals("Exception message", exception.getMessage());
