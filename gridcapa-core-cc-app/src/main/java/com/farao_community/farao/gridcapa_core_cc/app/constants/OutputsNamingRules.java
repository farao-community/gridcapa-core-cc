...
public final class OutputsNamingRules {
    ...
    public static final DateTimeFormatter INTERMEDIATE_METADATA_FILENAME_FORMATTER = DateTimeFormatter.ofPattern("yyyyMMdd'_'HH'30_METADATA-0V.txt'").withZone(ZONE_ID);
