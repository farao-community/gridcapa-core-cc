...
public class RaoParametersService {
    ...
    static void setPstPenaltyCost(final RequestMessage requestMessage, final RaoParameters raoParameters) {
    ...
    private static Double getNumericHeaderValue(final RequestMessage requestMessage, final String key) {
        ...
        return propertyOptional
                   .map(property -> Double.parseDouble(property.getValue()))
    ...
    private static String getEicIfAvailable(final String code, final VirtualHubsConfiguration virtualHubsConfiguration) {
