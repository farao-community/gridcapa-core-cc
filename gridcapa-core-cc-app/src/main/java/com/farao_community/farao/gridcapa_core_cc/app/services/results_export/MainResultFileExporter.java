...
public class MainResultFileExporter extends AbstractResultFileExporter {
    ...
    private static final String MAIN_SAMPLE_CSV_FILE = "outputs/%s-CCCORE-v[v].csv";
    ...
    public String exportStudyPointResult(List<StudyPointResult> studyPointResults, OffsetDateTime timestamp) {
        ...
        minioAdapter.uploadOutputForTimestamp(filePath, inStream, "CORE_CC", ResultType.MAIN_RESULT.getFileType(), timestamp);
